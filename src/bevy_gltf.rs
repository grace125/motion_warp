...
use bevy::asset::{
    AddAsset, AssetIoError, AssetLoader, AssetPath, BoxedFuture, Handle, LoadContext, LoadedAsset,
};
...
use bevy::ecs::{entity::Entity, prelude::FromWorld, world::World};
...
/// [`Transform`](bevy::transform::prelude::Transform) and an optional [`GltfExtras`].
...
async fn load_gltf<'a, 'b>(
    ...
    let (animations, named_animations, animation_roots) = {
        ...
        for animation in gltf.animations() {
            let mut animation_clip = crate::AnimationClip::default();
            ...
            for node in scene.nodes() {
                if animation_roots.contains(&node.index()) {
                    world
                        ...
                        .insert(crate::AnimationPlayer::default());
                }
            }
        }
